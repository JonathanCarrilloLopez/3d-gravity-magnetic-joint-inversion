...
!!! READING DATA!!!!!
 write(*,*) 'Reading data files (inversion) or models (fordard modelling)'
...
BB=ter22a+alpha1X*DxtDx+alpha1Y*DytDy+alpha1Z*DztDz+invCm02pr
PP=P2a
...
BB=ter22a+alpha1X*DxtDx+alpha1Y*DytDy+alpha1Z*DztDz
PP=P2a
